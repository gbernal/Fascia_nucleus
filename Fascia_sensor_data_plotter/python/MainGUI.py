...
class mainWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.FFT_CHANNEL = 7 #TODO: make sure this is the channel you want the FFT for (0 indexed)
        ...
        # for filters
        data_rate = 250 #TODO: make sure this matches the data rate of the ADS1299 in the firmware
        ...
        self.ip = '10.0.0.242' #TODO make sure this matches inet in en0 in ifconfig
